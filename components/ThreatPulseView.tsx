...
const REGION_COORDS: Record<string, [number, number]> = {
  ...
  "Kalimantan Barat": [109.3425, -0.0263],
  "Kepulauan Riau": [104.4447, 1.0825],
  "Aceh": [95.3193, 5.5483],
  "Sumatera Barat": [100.3719, -0.9471],
  "Riau": [101.4478, 0.5071],
  "Sumatera Selatan": [104.7566, -2.9909],
  "Lampung": [105.2663, -5.4292],
  "Yogyakarta": [110.3705, -7.7956],
  "Nusa Tenggara Barat": [116.3249, -8.6529],
  "Nusa Tenggara Timur": [121.5723, -8.6574],
  "Sulawesi Utara": [124.8484, 1.4748],
  "Maluku": [128.1814, -3.2384],
  "Papua": [138.0803, -4.2699],
  "Bangka Belitung": [106.1161, -2.1311],
  "Bengkulu": [102.2655, -3.7928],
  "Banten": [106.1091, -6.4058],
  "Gorontalo": [123.0595, 0.6999],
  "Jambi": [103.6131, -1.6101],
  "Kalimantan Selatan": [114.5910, -3.3194],
  "Kalimantan Tengah": [113.9213, -1.6814],
  "Kalimantan Utara": [116.5982, 2.9092],
  "Maluku Utara": [127.5388, 0.7893],
  "Papua Barat": [132.8996, -1.3361],
  "Sulawesi Tenggara": [122.5149, -4.1246],
  "Sulawesi Barat": [119.3324, -2.8441],
  "Sulawesi Tengah": [120.9821, -1.4300],
  "Global": [118.0, -2.0]
};
...
const REGION_MAPPINGS = [
  { name: "Jakarta", keywords: ["jakarta", "jkt", "jabodetabek", "raya", "indonesia"] },
  { name: "Jawa Barat", keywords: ["jawa barat", "jabar", "bandung", "depok", "bogor", "bekasi"] },
  { name: "Jawa Timur", keywords: ["jawa timur", "jatim", "surabaya", "malang", "sidoarjo", "kenjeran"] },
  { name: "Jawa Tengah", keywords: ["jawa tengah", "jateng", "semarang", "solo", "yogyakarta", "jogja", "solo baru"] },
  ...
  { name: "Kalimantan Timur", keywords: ["kalimantan timur", "kaltim", "samarinda", "balikpapan", "kalimantan"] },
  { name: "Kalimantan Barat", keywords: ["kalimantan barat", "kalbar", "pontianak"] },
  { name: "Kepulauan Riau", keywords: ["kepulauan riau", "kepri", "batam", "tanjung pinang"] },
  { name: "Aceh", keywords: ["aceh", "banda aceh"] },
  { name: "Sumatera Barat", keywords: ["sumatera barat", "sumbar", "padang"] },
  { name: "Riau", keywords: ["riau", "pekanbaru"] },
  { name: "Sumatera Selatan", keywords: ["sumatera selatan", "sumsel", "palembang"] },
  { name: "Lampung", keywords: ["lampung", "bandar lampung"] },
  { name: "Yogyakarta", keywords: ["yogyakarta", "jogja", "sleman", "bantul"] },
  { name: "Nusa Tenggara Barat", keywords: ["nusa tenggara barat", "ntb", "mataram", "lombok"] },
  { name: "Nusa Tenggara Timur", keywords: ["nusa tenggara timur", "ntt", "kupang"] },
  { name: "Sulawesi Utara", keywords: ["sulawesi utara", "sulut", "manado"] },
  { name: "Maluku", keywords: ["maluku", "ambon"] },
  { name: "Papua", keywords: ["papua", "jayapura"] },
  { name: "Bangka Belitung", keywords: ["bangka belitung", "babel", "pangkalpinang"] },
  { name: "Bengkulu", keywords: ["bengkulu"] },
  { name: "Banten", keywords: ["banten", "serang", "cilegon", "tangerang"] },
  { name: "Gorontalo", keywords: ["gorontalo"] },
  { name: "Jambi", keywords: ["jambi"] },
  { name: "Kalimantan Selatan", keywords: ["kalimantan selatan", "kalsel", "banjarmasin"] },
  { name: "Kalimantan Tengah", keywords: ["kalimantan tengah", "kalteng", "palangkaraya"] },
  { name: "Kalimantan Utara", keywords: ["kalimantan utara", "kalara", "tarakan"] },
  { name: "Maluku Utara", keywords: ["maluku utara", "ternate"] },
  { name: "Papua Barat", keywords: ["papua barat", "manokwari"] },
  { name: "Sulawesi Tenggara", keywords: ["sulawesi tenggara", "sultra", "kendari"] },
  { name: "Sulawesi Barat", keywords: ["sulawesi barat", "sulbar", "mamuju"] },
  { name: "Sulawesi Tengah", keywords: ["sulawesi tengah", "sulteng", "palu"] }
];
