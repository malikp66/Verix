    ...
    <div className="min-h-screen bg-neutral-950 relative overflow-hidden flex items-center justify-center">
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-lg mx-auto px-6">
        ...
        <motion.div
          ...
          className="w-full bg-neutral-900/50 backdrop-blur-xl border border-neutral-800/60 rounded-2xl p-8 shadow-2xl"
        >
          ...
          {error.digest && (
            <div className="mb-6 p-3 bg-black/40 rounded-lg border border-neutral-800/40">
              <code className="text-[9px] font-mono text-neutral-500 break-all">Trace ID: {error.digest}</code>
            </div>
          )}
        ...
        {/* Decorative footer */}
        <p className="mt-8 text-[9px] font-mono text-neutral-700 tracking-widest uppercase">
